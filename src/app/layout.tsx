...
export const metadata: Metadata = {
  title: "Luxury Stay Hotel - Premium Accommodations & Service",
  description: "Discover luxury hospitality at Luxury Stay Hotel. World-class amenities, fine dining, spa services, and exceptional guest experiences in the heart of the city.",
  keywords: "luxury hotel, premium accommodation, fine dining, spa resort, city hotel, business hotel",
  metadataBase: new URL("https://luxurystay.hotel"),
  alternates: {
    canonical: "https://luxurystay.hotel"
  },
  openGraph: {
    title: "Luxury Stay Hotel - Your Dream Destination",
    description: "Experience unparalleled luxury and comfort at our award-winning hotel with world-class amenities and impeccable service.",
    url: "https://luxurystay.hotel",
    siteName: "Luxury Stay Hotel",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763548703177-8htyx4ka.jpg",
  ...
  twitter: {
    ...
    description: "Premium accommodations with world-class service and amenities",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763548703177-8htyx4ka.jpg"]
  }
};
